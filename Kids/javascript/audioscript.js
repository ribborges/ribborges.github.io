...
var apple = new Audio('audio/apple.mp3');
var ball = new Audio('audio/ball.mp3');
var lion = new Audio('audio/lion.mp3');
var book = new Audio('audio/book.mp3');
var sun = new Audio('audio/sun.mp3');
var moon = new Audio('audio/moon.mp3');
var flower = new Audio('audio/flower.mp3');
var coffee = new Audio('audio/coffee.mp3');
var smile = new Audio('audio/smile.mp3');
var house = new Audio('audio/house.mp3');
var five = new Audio('audio/five.mp3');
