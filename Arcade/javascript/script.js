...
function Card(picture){
	var IMAGE_QUESTION  = "https://img.icons8.com/nolan/128/000000/question-mark.png"
...
function CardGame (cards , controllerLogicGame,scoreBoard){
	...
	this.clear = function (){
		var game = document.getElementById("col2");
		game.innerHTML = '';
	}
...
function BuilderCardGame(){
	var pictures = new Array ('img/card10.png','img/card10.png',
		'img/card1.png','img/card1.png',
		'img/card2.png','img/card2.png',
		'img/card3.png','img/card3.png',
		'img/card4.png','img/card4.png',
		'img/card5.png','img/card5.png',
		'img/card6.png','img/card6.png',
		'img/card7.png','img/card7.png',
		'img/card8.png','img/card8.png',
		'img/card9.png','img/card9.png');
